...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-03 (commit b79de01). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.06/10 avg, hotspot health 6.73/10 (stable), worst `src/torve/cli/run.py` at 1.34/10 · maintainability 9.17/10 · performance risk 142 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `src/torve/cli/evals.py` — function hotspot (eval_cmd) — impact −1.8
