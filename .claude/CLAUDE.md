...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-03 (commit 59b0548). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 7.3/10 avg, hotspot health 5.49/10 (stable), worst `src/torve/cli/run.py` at 1.0/10 · maintainability 9.1/10 · performance risk 166 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
