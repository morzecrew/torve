...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-01 (commit 50e43f6). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 7.97/10 avg, hotspot health 6.7/10 (stable), worst `src/torve/application/intake.py` at 2.0/10 · maintainability 9.13/10 · performance risk 157 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
