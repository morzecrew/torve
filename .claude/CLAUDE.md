...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-03 (commit 2b186c6). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.06/10 avg, hotspot health 6.72/10 (stable), worst `src/torve/cli/run.py` at 1.34/10 · maintainability 9.17/10 · performance risk 142 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
