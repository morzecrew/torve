...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-02 (commit c69ec4f). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.05/10 avg, hotspot health 6.74/10 (stable), worst `src/torve/application/intake.py` at 2.0/10 · maintainability 9.17/10 · performance risk 155 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
