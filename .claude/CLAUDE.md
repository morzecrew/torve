...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-28 (commit f927968). Confidence: 100%.
...
- `src/torve/application/tracker.py` — 4 bug fixes, last fix today (bug magnet); 22 commits/90d
- `tests/test_tracker.py` — 4 bug fixes, last fix today (bug magnet); 18 commits/90d
- `tests/test_broker.py` — 3 bug fixes, last fix today; 5 commits/90d
- `src/torve/application/runner.py` — 3 bug fixes, last fix today; 25 commits/90d
- `tests/test_reaper.py` — 3 bug fixes, last fix today; 9 commits/90d

### Code health
Three co-equal signals: defect risk 7.12/10 avg, hotspot health 5.11/10 (stable), worst `src/torve/cli/merge.py` at 1.02/10 · maintainability 9.07/10 · performance risk 110 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `rfcs/0019-standing-loop.md` — change entropy — impact −3.0
- `rfcs/0005-review-as-a-run.md` — change entropy — impact −2.3
- `rfcs/0008-tracker-projection.md` — change entropy — impact −2.1
