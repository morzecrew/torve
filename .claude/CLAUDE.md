...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-03 (commit 74c8e5d). Confidence: 100%.
...
- `src/torve/application/runner.py` — 9 bug fixes, last fix yesterday (bug magnet); 46 commits/90d
...
### Code health
Three co-equal signals: defect risk 7.27/10 avg, hotspot health 5.41/10 (stable), worst `src/torve/cli/run.py` at 1.0/10 · maintainability 9.11/10 · performance risk 160 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
