...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-02 (commit e668016). Confidence: 100%.
...
- `web/src/tabs.jsx` — 3 bug fixes, last fix yesterday; 6 commits/90d

### Code health
Three co-equal signals: defect risk 8.02/10 avg, hotspot health 6.77/10 (stable), worst `src/torve/application/intake.py` at 2.0/10 · maintainability 9.15/10 · performance risk 159 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
