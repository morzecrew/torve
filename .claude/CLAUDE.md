...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-02 (commit d2dba75). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.01/10 avg, hotspot health 6.72/10 (stable), worst `src/torve/application/intake.py` at 2.0/10 · maintainability 9.14/10 · performance risk 158 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
