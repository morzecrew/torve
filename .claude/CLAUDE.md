...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-02 (commit 1a8c84f). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.0/10 avg, hotspot health 6.75/10 (stable), worst `src/torve/application/intake.py` at 2.0/10 · maintainability 9.14/10 · performance risk 159 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
