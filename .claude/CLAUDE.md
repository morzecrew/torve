...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-03 (commit aafee53). Confidence: 100%.
...
- `src/torve/application/tracker.py` — 4 bug fixes, last fix 6 days ago (bug magnet); 23 commits/90d
- `tests/test_tracker.py` — 4 bug fixes, last fix 6 days ago (bug magnet); 18 commits/90d

### Code health
Three co-equal signals: defect risk 7.3/10 avg, hotspot health 5.49/10 (stable), worst `src/torve/cli/run.py` at 1.0/10 · maintainability 9.09/10 · performance risk 161 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
