...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-01 (commit 60e37e6). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 7.96/10 avg, hotspot health 6.68/10 (stable), worst `src/torve/application/intake.py` at 2.0/10 · maintainability 9.12/10 · performance risk 140 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
