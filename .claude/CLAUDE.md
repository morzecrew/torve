...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-28 (commit 8effc9e). Confidence: 100%.
...
- `src/torve/application/reaper.py` — 3 bug fixes, last fix today; 11 commits/90d
- `src/torve/application/lane.py` — 3 bug fixes, last fix yesterday; 18 commits/90d

### Code health
Three co-equal signals: defect risk 7.11/10 avg, hotspot health 5.09/10 (stable), worst `src/torve/cli/merge.py` at 1.02/10 · maintainability 9.07/10 · performance risk 165 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
