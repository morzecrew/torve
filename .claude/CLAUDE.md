...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-03 (commit b6cd14f). Confidence: 100%.
...
- `src/torve/application/projections.py` — 8 bug fixes, last fix yesterday (bug magnet); 30 commits/90d
- `src/torve/application/runner.py` — 9 bug fixes, last fix yesterday (bug magnet); 48 commits/90d
- `src/torve/application/review.py` — 4 bug fixes, last fix today (bug magnet); 19 commits/90d
...
### Code health
Three co-equal signals: defect risk 7.26/10 avg, hotspot health 5.41/10 (stable), worst `src/torve/cli/run.py` at 1.0/10 · maintainability 9.11/10 · performance risk 140 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `rfcs/0003-runner-isolation.md` — change entropy — impact −2.0
