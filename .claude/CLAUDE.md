...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-02 (commit 5ccef53). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.03/10 avg, hotspot health 6.69/10 (stable), worst `src/torve/cli/run.py` at 1.34/10 · maintainability 9.16/10 · performance risk 166 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
