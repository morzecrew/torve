...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-03 (commit 057584d). Confidence: 100%.
...
- `src/torve/application/runner.py` — 9 bug fixes, last fix 2 days ago (bug magnet); 46 commits/90d
- `src/torve/application/review.py` — 5 bug fixes, last fix today (bug magnet); 21 commits/90d
...
### Code health
Three co-equal signals: defect risk 7.29/10 avg, hotspot health 5.47/10 (stable), worst `src/torve/cli/run.py` at 1.0/10 · maintainability 9.09/10 · performance risk 166 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
