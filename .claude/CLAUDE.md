...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-02 (commit 3e2cb48). Confidence: 100%.
...
- `src/torve/application/projections.py` — 8 bug fixes, last fix today (bug magnet); 29 commits/90d
- `src/torve/application/runner.py` — 9 bug fixes, last fix today (bug magnet); 45 commits/90d
...
- `web/src/tabs.jsx` — 3 bug fixes, last fix today; 6 commits/90d

### Code health
Three co-equal signals: defect risk 7.99/10 avg, hotspot health 6.71/10 (stable), worst `src/torve/application/intake.py` at 2.0/10 · maintainability 9.14/10 · performance risk 158 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
