...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-01 (commit 31663dc). Confidence: 100%.
...
- `src/torve/application/runner.py` — 8 bug fixes, last fix today (bug magnet); 44 commits/90d
...
### Code health
Three co-equal signals: defect risk 7.96/10 avg, hotspot health 6.65/10 (stable), worst `src/torve/application/intake.py` at 2.0/10 · maintainability 9.13/10 · performance risk 157 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
