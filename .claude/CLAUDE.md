...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-01 (commit 1855409). Confidence: 100%.
...
- `src/torve/application/projections.py` — 7 bug fixes, last fix today (bug magnet); 26 commits/90d
- `src/torve/application/runner.py` — 7 bug fixes, last fix today (bug magnet); 43 commits/90d
- `src/torve/application/tracker.py` — 4 bug fixes, last fix 3 days ago (bug magnet); 23 commits/90d
- `tests/test_tracker.py` — 4 bug fixes, last fix 3 days ago (bug magnet); 18 commits/90d
- `src/torve/application/intake.py` — 3 bug fixes, last fix yesterday; 21 commits/90d

### Code health
Three co-equal signals: defect risk 7.97/10 avg, hotspot health 6.68/10 (stable), worst `src/torve/application/intake.py` at 2.0/10 · maintainability 9.12/10 · performance risk 140 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `src/torve/gates/source_layout.py` — untested hotspot — impact −2.0
- `src/torve/cli/sandbox.py` — untested hotspot — impact −2.0
- `src/torve/cli/review.py` — untested hotspot — impact −2.0
- `src/torve/cli/context.py` — function hotspot (_render_rich) — impact −1.6
- `src/torve/cli/run.py` — function hotspot (run_cmd) — impact −1.5
