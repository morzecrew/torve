...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-02 (commit 4ca9f34). Confidence: 100%.
...
- `src/torve/application/projections.py` — 8 bug fixes, last fix today (bug magnet); 30 commits/90d
...
### Code health
Three co-equal signals: defect risk 8.01/10 avg, hotspot health 6.77/10 (stable), worst `src/torve/application/intake.py` at 2.0/10 · maintainability 9.14/10 · performance risk 159 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
