...
supersedes: []
superseded_by: "0055"
amended_by: ["A-27", "A-28", "A-29", "A-31", "A-34", "A-39", "A-94", "A-105", "A-145"]
retired: ["D-19.1", "D-19.2", "D-19.3", "D-19.4", "D-19.6", "D-19.8", "D-19.14"]
owner: Lev Litvinov
description: >-
...
D-19.14 was retired 2026-09-09; path rot. The identifier is never reused.

D-19.8 was retired 2026-09-09; path rot. The identifier is never reused.

D-19.6 was retired 2026-09-09; path rot. The identifier is never reused.

D-19.4 was retired 2026-09-09; path rot. The identifier is never reused.

D-19.3 was retired 2026-09-09; path rot. The identifier is never reused.

D-19.2 was retired 2026-09-09; path rot. The identifier is never reused.

D-19.1 was retired 2026-09-09; path rot. The identifier is never reused.
...
### A-145 — 2026-09-09 — 7 path-rotted row(s) retired by `torve rfc check --fix-rot`
```yaml changes
- subject: D-19.1
  field: retired
  before: src/torve/application/loop.py src/torve/cli/tick.py
  after: "path rot: every declared glob matches nothing in the tree"
- subject: D-19.2
  field: retired
  before: src/torve/application/loop.py
  after: "path rot: every declared glob matches nothing in the tree"
- subject: D-19.3
  field: retired
  before: src/torve/application/loop.py
