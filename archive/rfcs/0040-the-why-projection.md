...
owner: Lev Litvinov
description: >-
  One on-demand per-task projection — torve why — joining attempt rows, verdicts, convictions, reviews, escalations and costs into a chronological timeline, rendered by CLI, MCP and serve from one reader.
schema_version: 1
---
