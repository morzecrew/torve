...
supersedes: []
superseded_by: "0055"
amended_by: ["A-60", "A-61", "A-63", "A-108", "A-146"]
retired: ["D-24.10"]
owner: Lev Litvinov
description: >-
...
D-24.10 was retired 2026-09-09; path rot. The identifier is never reused.
...
### A-146 — 2026-09-09 — 1 path-rotted row(s) retired by `torve rfc check --fix-rot`
```yaml changes
- subject: D-24.10
  field: retired
