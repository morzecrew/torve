...
owner: Lev Litvinov
description: >-
  The package layout of src/torve — layers, permitted import directions, module naming, adapter organisation, and the layering gate that enforces the enforceable half.
schema_version: 1
---
