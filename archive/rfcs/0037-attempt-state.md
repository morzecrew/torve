...
owner: Lev Litvinov
description: >-
  An agent-authored working-state snapshot (state.yaml) carried by the worktree across continuations: what a dying attempt knew, for the next attempt and for triage — never for routing.
schema_version: 1
---
