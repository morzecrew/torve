...
D-17.9 was retired 2026-09-09; path rot. The identifier is never reused.
...
### A-144 — 2026-09-09 — 1 path-rotted row(s) retired by `torve rfc check --fix-rot`
```yaml changes
- subject: D-17.9
  field: retired
  before: "\"socket\" — socket mounts the host daemon into every sandbox of the run attempt
  and gates alike the image supplies the docker CLI off by default. A nested daemon
  is the named deferred stronger mode. Added by amendment A-24 2026-08-22"
