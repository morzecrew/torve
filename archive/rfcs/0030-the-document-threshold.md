...
owner: Lev Litvinov
description: >-
  When work must carry its own document and when it may ride the standing corpus: paths-intersection inheritance for document-less contracts and a deterministic threshold that routes large or LOCKED-crossing work to authoring.
schema_version: 1
---
