...
owner: Lev Litvinov
description: >-
  Mechanical writers over the corpus parser — a canonical emitter, torve rfc fmt, and transactional verbs for amendments, decisions, retirement and path relocation — so the structure-bearing edits stop being hand-typed.
schema_version: 1
---
