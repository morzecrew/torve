...
D-42.6 was retired 2026-09-09; path rot. The identifier is never reused.

D-42.5 was retired 2026-09-09; path rot. The identifier is never reused.
...
### A-147 — 2026-09-09 — 2 path-rotted row(s) retired by `torve rfc check --fix-rot`
```yaml changes
- subject: D-42.5
  field: retired
