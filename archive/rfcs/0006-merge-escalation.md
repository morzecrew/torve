...
supersedes: []
superseded_by: "0055"
amended_by: ["A-35", "A-42", "A-43", "A-115", "A-127", "A-142"]
retired: ["D-6.11"]
owner: Lev Litvinov
description: >-
...
D-6.11 was retired 2026-09-09; path rot. The identifier is never reused.
...
### A-142 — 2026-09-09 — 1 path-rotted row(s) retired by `torve rfc check --fix-rot`
```yaml changes
- subject: D-6.11
  field: retired
