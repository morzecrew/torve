...
supersedes: []
superseded_by: "0055"
amended_by: ["A-6", "A-13", "A-18", "A-38", "A-50", "A-112", "A-120", "A-141"]
retired: ["D-3.18"]
owner: Lev Litvinov
description: >-
...
D-3.18 was retired 2026-09-09; path rot. The identifier is never reused.
...
### A-141 — 2026-09-09 — 1 path-rotted row(s) retired by `torve rfc check --fix-rot`
```yaml changes
- subject: D-3.18
  field: retired
