...
- `src/torve/adapters/agent/` — 4 decision(s)
...
- `src/torve/application/` — 75 decision(s)
- `src/torve/base/` — 2 decision(s)
- `src/torve/cli/` — 31 decision(s)
- `src/torve/config/` — 34 decision(s)
- `src/torve/domain/` — 30 decision(s)
- `src/torve/gates/` — 23 decision(s)
- `tests/` — 1 decision(s)
- `web/` — 1 decision(s)
