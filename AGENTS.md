...
- `src/torve/adapters/vcs/` — 4 decision(s)
- `src/torve/adapters/workspace/` — 2 decision(s)
- `src/torve/application/` — 157 decision(s)
- `src/torve/base/` — 2 decision(s)
- `src/torve/cli/` — 58 decision(s)
- `src/torve/config/` — 75 decision(s)
- `src/torve/domain/` — 36 decision(s)
- `src/torve/gates/` — 32 decision(s)
- `tests/` — 9 decision(s)
- `web/` — 1 decision(s)
