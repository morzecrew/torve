...
### S-0056/D-6 — `LOCKED` (Structure for everything) — implementation: none
...
### S-0056/D-7 — `ASSUMED` (Structure for everything) — implementation: none
...
### S-0088/D-4 — `ASSUMED` (A minted contract follows its amended document)
