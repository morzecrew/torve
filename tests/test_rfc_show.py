...
from torve.config.spec import document_dirs, lookup, next_amendment
...
DOC = document(
    ...
    retired=["D-90.9"],
    sections=[{"key": "design", "md": "The frob honours D-90.1 throughout.\n"}],
    phasing=[
        {
            "phase": 1,
            "title": "the-core",
...
def test_amendment_heading_and_the_rows_its_diff_names(tmp_path):
    ...
    assert next_amendment(document_dirs(rfcs)) == "A-4"
