...
| D-7.27 | `ASSUMED` | `torve rfc graph` renders the corpus as a dependency tree: roots first, a node expands under its first parent and back-references elsewhere, standalone documents appear as bare roots. Added by execution 2026-08-22 — see .torve/tasks/T-0032 | `src/torve/cli/rfc.py` | — |
