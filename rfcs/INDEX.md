...
| [0054](0054-decisions-as-gates-and-the-projections-beside-the-code.md) | Decisions as gates and the projections beside the code | accepted | none | 0053 | A-153, A-154, A-155, A-156, A-158, A-159, A-160 | The backends over RFC 0053's model: a decision with a check runs as a gate and owes no attestation; the rows governing a directory are rendered beside it; a sandbox reads the specification through a verb; and a deterministic context pack carries the facts the corpus cannot. |
