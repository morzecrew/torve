...
| [0003](0003-runner-isolation.md) | Runner and isolation | accepted | partial | 0002 | A-6, A-13, A-18, A-38 | `torve run` for one task synchronously: sandbox lifecycle, lease and cancellation, reaper, and the simulation harness that proves the state machine. |
...
| [0005](0005-review-as-a-run.md) | Review as a run | accepted | partial | 0003, 0004 | A-32 | Independent automated review as a second run role: isolation rules, the finding contract, calibration, and replacing third-party PR reviewers. |
| [0006](0006-merge-escalation.md) | Merge train and escalation policy | accepted | partial | 0003 | A-35 | Serialized landing of candidates, promotion criteria, escalation routing, and how human attention is budgeted. |
...
| [0008](0008-tracker-projection.md) | Tracker projection | accepted | complete | 0003 | A-30, A-33, A-36 | Any task tracker as a presentation surface: outbound projection over the outbox, restricted inbound commands, no authoritative state in the board. |
