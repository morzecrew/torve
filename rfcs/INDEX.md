...
| [0029](0029-agent-equipment.md) | Agent equipment | draft | none | 0009, 0027, 0028 | — | Per-tier skill sets and prompt extras layered over role-scoped defaults, so a named variant becomes a persona — equipped, addressable from a document's phasing, and measured as its own regime by machinery that already exists. |
